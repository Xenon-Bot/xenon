...
class BackupHandler:
        ...
        for member in self.data["members"]:
            ...
            try:
                async with session.put(
                        url=f"https://discordapp.com/api/v6/guilds/{self.guild.id}/members/{member['id']}",
                        headers={'Authorization' : f"Bot {statics.token}"},
    ...
    def get_backup_info(self, data: dict):
        ...
        embed.add_field(name="Channels", value=channel_tree)
